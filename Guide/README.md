# 📚 NEPSE Floorsheet Analytics — User Guides Hub

Welcome to the complete official guide library for the **NEPSE Floorsheet Visualizer & Smart Money Platform**. Whether you are a beginner looking to understand raw trade feeds or an active trader tracking institutional accumulation, these detailed guides cover every feature of the platform.
...
For maximum analytical efficiency, follow this 4-step daily routine:

```
[ Step 1: Macro Check ]
    └── Market Overview (/overview) & Time Patterns (/time-patterns)
        Check if total turnover is expanding and identify peak liquidity hours.

[ Step 2: Screen Leaders & Whales ]
    └── Symbol Analysis (/symbols) & Market Radar (/radar)
