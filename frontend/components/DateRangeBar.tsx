...
export function DateRangeBar() {
  const { startDate, endDate, rangeLabel, setRange } = useDateRange()

  return (
    <div className="sticky top-[49px] z-20 border-b border-border/50 bg-background/70 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-3 px-6 py-1.5">
        ...
        <span className="text-[11px] text-muted-foreground hidden sm:inline whitespace-nowrap flex-shrink-0">
          {startDate && endDate
